  ...
  return (
    ...
    >
      <div className="py-8 px-20 mx-auto max-w-screen-xl text-center ">
        <h1 className="mb-11 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-ligthGreen to-whiteLike">
